# Boros Carry Demo Pack

This is a demo **Wayfinder Pack** that ships a static applet and a small script to generate a Delta Lab-shaped dataset for **Boros** carry (fixed vs floating) versus underlying price.
...
poetry run wayfinder pack publish --path . --out dist/bundle.zip

# emit a signal so the pack page feels alive
poetry run wayfinder pack signal emit --slug boros-carry-demo --title "Backtest updated" --message "Regenerated demo dataset"
```
